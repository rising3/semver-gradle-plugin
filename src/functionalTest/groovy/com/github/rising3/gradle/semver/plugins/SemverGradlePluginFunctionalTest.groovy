...
class SemverGradlePluginFunctionalTest extends Specification {
    ...
    def "can run semver task"() {
        ...
        '' | ['semver', '--prerelease', '--preid', 'RC'] | 'info New version: 0.0.0-RC.0'
        '' | ['semver', '--premajor', '--preid', 'RC'] | 'info New version: 1.0.0-RC.0'
        '' | ['semver', '--preminor', '--preid', 'RC'] | 'info New version: 0.1.0-RC.0'
        '' | ['semver', '--prepatch', '--preid', 'RC'] | 'info New version: 0.0.1-RC.0'
